...
import { ExecuteQueryService } from "../database_operations/execute-query.service";
...
export class SqlCommandsService {
  ...
  private queryExecuter: ExecuteQueryService;
  ...
  constructor() {
    ...
    this.queryExecuter = ExecuteQueryService.getInstance();
